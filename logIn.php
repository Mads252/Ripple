...
<body>
    ...
    <div class="log-in-container">
       ...
       <form action="includes/logInIncludes.php"  method="post" class="log-in-form">
        <div>
            <p class="inputP">Brugernavn eller Email</p>
            <input type="text" name="userId" class="input-login" placeholder="Ripple@mail.dk">
        </div>
        <div>
            <p class="inputP">Password</p>
